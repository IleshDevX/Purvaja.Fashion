  ...
  return (
    <footer className="bg-ivory-100 px-4 pb-10 pt-4 sm:px-6 lg:px-10 lg:pb-14">
      ...
      <div className="mx-auto max-w-[1720px] rounded-[32px] sm:rounded-[36px] bg-[#121212] border border-white/10 p-8 sm:p-12 lg:p-14 text-ivory-100 shadow-[0_25px_70px_rgba(0,0,0,0.35)] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.3fr_auto_1fr_1fr_auto_auto] items-start">
          ...
          <div className="max-w-md">
            ...
            {/* Headline */}
            <h3 className="mt-6 font-serif text-2xl sm:text-3xl font-light text-white leading-snug">
            ...
            <div className="mt-8">
              ...
              <form onSubmit={handleSubscribe} className="relative max-w-sm">
                <input
                  ...
                  className="w-full rounded-full border border-white/15 bg-white/[0.06] py-3.5 pl-5 pr-14 text-xs text-white placeholder:text-white/40 focus:border-gold-400 focus:bg-white/[0.09] focus:outline-none transition-all duration-300"
                  required
                />
                <button
                  type="submit"
                  aria-label="Subscribe"
                  className="absolute right-1.5 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-white/15 text-white hover:bg-gold-400 hover:text-charcoal-950 transition-all duration-300 active:scale-95"
                >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3.5 text-xs font-medium text-ivory-200/70 sm:text-sm">
              <li>
